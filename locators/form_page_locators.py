...
class FormPageLocators:
    ...
    # class* - по первым словам класса найдёт его в DOM дереве, делаем f строкой для выбора гендера по трём r_b (random)
    ...
    # table_result
    RESULT_TABLE = (By.XPATH, '//div[@class="table-responsive"]//td[2]')   # xpath, //талица -->//td[2] элементы второго столбца(10)
